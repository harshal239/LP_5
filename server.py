...
def synchronizeAllCloks():
    ...
    while True:
        ...
        if len(client_data) > 0:
            ...
            print("No client data. Synchroniztion not applicable.\n")
...
def initiateClockServer(port = 8080):
    ...
    print("Socket at master node created sucessfully.\n\n")
    ...
    print("Starting synchroniztion partially...\n")
    sync_thread = threading.Thread(target= synchronizeAllCloks, args=())
    sync_thread.start()
